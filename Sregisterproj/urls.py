"""
URL configuration for Sregisterproj project.
...
from SregisterApp.views import StudentDetailView, StudentListView, add_project, courselist, enrolledStudents, enrolledStudentsUsingAjax, generateCSV, generatePDF, home, register, registerAjax, studentlist
